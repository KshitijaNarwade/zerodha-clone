...
const Stats = () => {
  return (
    <div className='container p-2 m-auto w-100'>
      <div className="row p-5">
        <div className="col-6 p-5">
          <h1 className='fs-2 mb-5'>Trust with confidence</h1>
          <h2 className='fs-4'>Customer-first always</h2>
          <p className='text-muted'>That's why 1.3+ crore customers trust Zerodha with ₹3.5+ lakh crores worth of equity inverstments.</p>
          ...
          <p className='text-muted'>Not just an app, but a whole ecosystem. Our inverstments in 30+ fintech startups offer you tailored services specific to your needs.</p>
