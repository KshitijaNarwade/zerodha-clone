...
const Hero = () => {
  return (
    ...
    <div className="container w-100 h-auto">
      <div className="row w-100 h-auto p-5 mt-5 mb-5">
        <p className="fs-2 text-center fw-normal w-100 h-auto">
      ...
      <div
        className="row w-100 h-auto p-5 mt-5 border-top"
        style={ { lineHeight: "2", fontSize: "1.1em" } }
      >

        <div className="col-12 col-md-6 w-100 h-auto mb-4">
          <p>
        ...
        <div className="col-12 col-md-6 w-100 h-auto">
          <p>
          ...
          <p>
            ...
            fund and incubator, has invested in several fintech startups with the
